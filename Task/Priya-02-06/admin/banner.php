...
$adminid = $_SESSION['admin_credential']['admin_id'];
 ...
 $select_query = mysqli_query($_connection,"SELECT * FROM `company_banner`");
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <img src="../banner/<?php echo $display_image?>" height="100" width="100">
                              ...
                              <button type="submit" class="btn btn-info btn-fill pull-right" name="edit_banner">Edit Speaker Profile</button>
