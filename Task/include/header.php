...
<html lang="en">
	<head>
        <title>IndiaNIC - Internship </title>
                            ...
                            <ul class="flex-column mr-auto">
                                ...
                                <li class="nav-item dropdown">
                                            ...
                                            <ul id="MenuDropdown" class="sub-navbar collapse flex-column">
                                                <li class="nav-item"><a class="nav-link" href="www.indianic.com">Style Examples</a></li>
                                                <li class="nav-item"><a class="nav-link" href="www.google.com">Three Column</a></li>
